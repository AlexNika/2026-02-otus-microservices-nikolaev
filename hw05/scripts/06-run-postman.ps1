param(
  [string]$Collection = '.\postman\otus-hw5.postman_collection.json',
...
if ($ExitCode -ne 0) {
    ...
    Write-Host "---> This is expected due to simulateRandomError() (10% chance of 500 errors)" -ForegroundColor Yellow
    if ($HtmlReport) {
